...
def main():
    ...
    print(""" Welcome to TEK Password Manager
    ...
    while not done:
        ...
        if choice == "1":
            ...
            passwordCheck = input("Enter a password to check it's security: ")
            print("Security level of entered password is: ", end=" ")
            print(pm.get_level(passwordCheck))
        elif choice == "q":
            done = True
            print("Thank you for using TEK Password Manager !")
        else:
